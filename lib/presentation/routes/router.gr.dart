...
extension RouterExtendedNavigatorStateX on ExtendedNavigatorState {
  ...
  Future<dynamic> pushNoteFormPage({
    Key key,
    @required Note edittedNote,
  }) =>
      push<dynamic>(
        Routes.noteFormPage,
        arguments: NoteFormPageArguments(key: key, edittedNote: edittedNote),
      );
}
...
class NoteFormPageArguments {
  ...
  NoteFormPageArguments({this.key, @required this.edittedNote});
}
